...
По-умолчанию в любом новом репозитории GitHub предлагается создать пустой файл `README.md`. Он является главной страницей репозитория (аналог `index.html`) и автоматически отображается при открытии репозитория в брайзере.
